          ...
          <div className="lg:flex lg:flex-row lg:items-start xs:flex xs:flex-col xs:items-center pb-[270px]">
            <div className="w-70 ml-4 flex flex-col ">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <p className="leading-relaxed pb-5 border-b-2 border-gray-light mb-5 mt-6 text-gray-dark ">
                  {description}
                </p>
                ...
                <span className="title-font w-full font-bold font-medium text-2xl text-gray-dark">
                  ...
                  <button
                    onClick={handleLike}
                    className="rounded-full w-[200px] h-10 bg-gray-200 p-0 border-0 inline-flex items-start align-middle justify-between text-gray-500 ml-4"
                  >
                    <svg
